...
A highly polished, production-tier Home Assistant integration to track your Office Tracker compliance!
...
## Getting Started
After installing this repository, simply restart Home Assistant, go to **Settings -> Devices & Services**, click **Add Integration**, and search for "Office Tracker" to launch the wizard!
